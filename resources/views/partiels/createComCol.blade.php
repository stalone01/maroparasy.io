            ...
            <div class="p-4 md:p-5">
                <form class="space-y-4" action="{{ route('commentC',$colline->id) }}" method="POST">
                    ...
                    <div>
                          ...
                          <input type="text" name="contenu" id="contenu" placeholder="entrer votre commentaire" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required />
